...
const profileImgUpload = multer({
  storage: multerS3({
    s3: s3,
    bucket: "aga-file-uploads/esyllabus",
    acl: "public-read",
  ...
  limits: {
    fileSize: 5000000000
  }, // In bytes: 5000000000 bytes = 5 GB
...
function checkFileType(file, cb) {
  // Allowed ext
  const filetypes = /jpeg|jpg|pdf|zip/;
  // Check ext
...
router.delete("/multiple-file-upload", (req, res) => {
  ...
  var deleteParam = {
    ...
    Delete: {
      Objects: [{ Key: `esyllabus/${fileName}` }]
    }
  };
